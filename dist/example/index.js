...
/***/ (function(module, exports, __webpack_require__) {
	...
	var Test = function () {
	    ...
	    _createClass(Test, [{
	        ...
	        key: 'resetMinionSize',
	        value: function resetMinionSize() {
	            // 기본 싸이즈가 아니면
	            if (minion.width !== 200) {
	                minion.width = 200;
	        ...
	        key: 'resetMinion',
	        value: function resetMinion() {
	            var target = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : minion;
	            var justSize = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : false;
	        ...
	        key: 'drawAfterimage',
	        value: function drawAfterimage(to, from, time, easing) {
	            var _this2 = this;
	
	            var completeCallback = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : null;
	            ...
	            var vector = _Vector2.default.fromObject(from);
	            vector.alpha = 0.1;
	            ...
	            this.drawAfterTween.onUpdate = function () {
	                _this2.setAfterimage(_this2.drawAfterimageIndex, vector);
	                _this2.drawAfterimageIndex++;
	            };
	        ...
	        value: function drawBezierAfterimage(to, from, control, time, easing) {
	            var _this3 = this;
	
	            var completeCallback = arguments.length > 5 && arguments[5] !== undefined ? arguments[5] : null;
	            ...
	            this.drawBezierAfterTween = Be.bezier(vector, to, from, _Vector2.default.fromObject(controlMinion), time, easing);
	        ...
	        key: 'drawPhysicalAfterimage',
	        value: function drawPhysicalAfterimage(to, from, easing) {
	            var _this4 = this;
	            ...
	            this.drawPhysicalAfterTween.onUpdate = function () {
	                _this4.setAfterimage(_this4.drawAfterimageIndex, vector);
	                _this4.drawAfterimageIndex++;
	            };
	
	            this.drawPhysicalAfterTween.onComplete = function () {
	                _this4.setAfterimage(_this4.drawAfterimageIndex, vector);
	                _this4.drawAfterimageIndex++;
	        ...
	        key: 'hideAfterImage',
	        value: function hideAfterImage(from, to) {
	            var _this5 = this;
	            ...
	            this.hideAfterTween.onUpdate = this.hideAfterTween.onComplete = function () {
	                minions[_this5.hideAfterimageIndex].visible = false;
	                _this5.hideAfterimageIndex++;
	            };
	        ...
	        value: function initializeGUI() {
	            ...
	            easingControl.onFinishChange(function (easingName) {
	                _this6.config.selectedEasing = _this6.config.easingList[_this6.getEasingIndex(easingName)];
	            });
	        ...
	        value: function tween() {
	            ...
	            var time = Number(this.config.time),
	                ...
	                from = _Vector2.default.fromObject(minion),
	                direction = from.clone().subtract(to);
	            from.rotation = minion.rotation;
	            to.rotation = direction.direction();
	
	            var cloneTo = Object.assign(to.clone(), to),
	                cloneFrom = Object.assign(from.clone(), from);
	
	            this.currentTween = this.minionTween = Be.tween(minion, to, from, time, easing);
	        ...
	        value: function to() {
	            ...
	            this.currentTween = this.minionTween = Be.to(minion, to, time, easing);
	            this.minionTween.play();
	        ...
	        value: function from() {
	            ...
	            this.currentTween = this.minionTween = Be.from(minion, to, time, easing);
	            this.minionTween.play();
	        ...
	        value: function apply() {
	            ...
	            this.drawAfterimage(cloneTo, cloneFrom, time, easing, function () {
	                setTimeout(function () {
	                    Be.apply(minion, applyTo, applyFrom, time, applyTime, easing);
	                }, 10);
	            });
	        }
	    }, {
	        ...
	        value: function bezier() {
	            ...
	            var time = Number(this.config.time),
	                ...
	                from = _Vector2.default.fromObject(minion),
	                direction = from.clone().subtract(to),
	                control = _Vector2.default.fromObject(controlMinion);
	            from.rotation = minion.rotation;
	            to.rotation = direction.direction();
	            ...
	            this.currentTween = this.minionTween = Be.bezier(minion, to, from, control, time, easing);
	            this.minionTween.play();
	        ...
	        value: function bezierTo() {
	            ...
	            this.currentTween = this.minionTween = Be.bezierTo(minion, to, control, time, easing);
	            this.minionTween.play();
	        ...
	        value: function bezierFrom() {
	            ...
	            this.currentTween = this.minionTween = Be.bezierFrom(minion, to, control, time, easing);
	            this.minionTween.play();
	        ...
	        value: function physical() {
	            ...
	            var targetX = 600,
	                ...
	                uniformTo = new _Vector2.default(targetX, 100),
	                uniformFrom = _Vector2.default.fromObject(minion),
	                accelerateTo = new _Vector2.default(targetX, 280),
	                accelerateFrom = _Vector2.default.fromObject(minion),
	                exponentialTo = new _Vector2.default(targetX, 460),
	                exponentialFrom = _Vector2.default.fromObject(minion);
	
	            minion0.x = this.minionHalfWidth, minion0.y = this.minionHalfHeight, minion0.alpha = 1, minion0.visible = true, minion1.x = this.minionHalfWidth, minion1.y = this.minionHalfHeight, minion1.alpha = 1, minion1.visible = true, minion2.x = this.minionHalfWidth, minion2.y = this.minionHalfHeight, minion2.alpha = 1, minion2.visible = true;
	
	            this.currentTween = this.uniform0 = Be.physical(minion0, uniformTo, uniformFrom, Physical.uniform(uniformSpeed));
	        ...
	        value: function physicalTo() {
	            ...
	            this.currentTween = this.uniform0 = Be.physicalTo(minion0, uniformTo, Physical.uniform(uniformSpeed));
	        ...
	        value: function physicalFrom() {
	            ...
	            this.currentTween = this.uniform0 = Be.physicalFrom(minion0, uniformTo, Physical.uniform(uniformSpeed));
	        ...
	        value: function parallel() {
	            ...
	            var bezier = Be.bezier(minion, to, from, center, 1, Back.easeOut),
	            ...
	            this.currentTween = this.group = Be.parallel(bezier, alpha, scale);
	            this.group.onComplete = function () {
	                var tween = Be.to(minion, { alpha: 1, width: 200 }, 0.5, Elastic.easeOut);
	                tween.onUpdate = tween.onComplete = function () {
	                    minion.scale.y = minion.scale.x;
	                };
	                tween.play();
	            };
	        ...
	        value: function parallelTweens() {
	            ...
	            this.currentTween = this.group = Be.parallelTweens(tweens);
	            this.group.onComplete = function () {
	                var tween = Be.to(minion, { alpha: 1, width: 200 }, 0.5, Elastic.easeOut);
	                tween.onUpdate = tween.onComplete = function () {
	                    minion.scale.y = minion.scale.x;
	        ...
	        value: function serial() {
	            ...
	            var startX = this.minionHalfWidth + 20,
	                startY = this.minionHalfHeight - 20,
	                centerX = 300 + 20,
	                centerY = 300 + 10,
	                endX = 600,
	                endY = 600,
	                lt = new _Vector2.default(startX, startY),
	                rt = new _Vector2.default(endX, startY),
	                rb = new _Vector2.default(endX, endY),
	                lb = new _Vector2.default(startX, endY),
	                center = new _Vector2.default(centerX, centerY),
	                time = 0.4,
	                easing = Back.easeOut,
	                from1 = _Vector2.default.fromObject(minion),
	                to1 = lt.clone(),
	                from2 = to1.clone(),
	                to2 = rt.clone(),
	                from3 = to2.clone(),
	            ...
	            var tween1 = Be.tween(minion, to1, from1, time, easing),
	            ...
	            this.currentTween = this.group = Be.serial(tween1, tween2, tween3, tween4, tween5, tween6);
	
	            this.group.onPlay = function () {
	                _this7.drawAfterimageIndex = 0;
	            };
	
	            this.group.onUpdateParams = [minion];
	
	            this.group.onUpdate = function (target) {
	                var afterImage = _Vector2.default.fromObject(target);
	                afterImage.alpha = 0.1;
	                afterImage.rotation = target.rotation;
	                _this7.setAfterimage(_this7.drawAfterimageIndex, afterImage);
	                _this7.drawAfterimageIndex++;
	            };
	        ...
	        value: function serialTweens() {
	            ...
	            this.currentTween = this.group = Be.serialTweens(tweens);
	
	            this.group.onPlay = function () {
	                _this8.drawAfterimageIndex = 0;
	            };
	            ...
	            this.group.onUpdate = function (target) {
	                ...
	                afterImage.alpha = 0.1;
	                afterImage.rotation = target.rotation;
	                _this8.setAfterimage(_this8.drawAfterimageIndex, afterImage);
	                _this8.drawAfterimageIndex++;
	            };
	        ...
	        value: function reverse() {
	            if (this.currentTween) {
	                this.resetTween();
	                this.currentTween = this.minionTween = Be.reverse(this.currentTween, true);
	                this.minionTween.play();
	            }
	        }
	    }, {
	        ...
	        value: function slice() {
	            if (this.currentTween) {
	                ...
	                this.minionTween.onComplete = function () {
	                    minion.width = 200;
	                    minion.scale.y = minion.scale.x;
	                };
	                this.minionTween.play();
	        ...
	        value: function removeFromParent() {
	            ...
	            for (var i = 0; i < 200; i++) {
	                ...
	                var t = Be.serial(Be.addChild(p, this.stage), Be.tween(p, {
	                    alpha: 0.8,
	                    _blurFilter: { blurX: 0, blurY: 0 }
	                }, {
	                    _blurFilter: { blurX: 16, blurY: 16 },
	                    alpha: 0
	                }, 3, null, Math.random() * 5), Be.tween(p, { alpha: 1 }, { alpha: 0.8 }, 2), Be.removeFromParent(p));
	        ...
	        key: 'showControlMinion',
	        value: function showControlMinion() {
	        ...
	        key: 'hideControlMinion',
	        value: function hideControlMinion() {
